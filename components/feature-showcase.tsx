...
import { Server, Shield, Zap, Clock, Database, Code, ChevronRight } from "lucide-react"
...
export function FeatureShowcase() {
  ...
  const features: Feature[] = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=400&width=600&query=cybersecurity%20shield%20protection%20digital%20concept",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=400&width=600&query=server%20uptime%20monitoring%20dashboard%20digital",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=400&width=600&query=cloud%20computing%20scalability%20concept%20digital",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=400&width=600&query=database%20management%20system%20digital%20concept",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=400&width=600&query=software%20development%20tools%20code%20digital",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mt-4 text-[#8f8f8f] md:text-lg max-w-3xl mx-auto">
            Nossa plataforma combina tecnologia de ponta com facilidade de uso para impulsionar seu crescimento online
          </p>
        </motion.div>
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-full flex items-center justify-center ${
                        activeFeature === feature.id ? `bg-gradient-to-r ${feature.color} bg-opacity-10` : `bg-gradient-to-r ${feature.color} bg-opacity-10`
                      }`}
                    >
                      {feature.icon}
                    </div>
                    <div>
                      <h3 className={`font-bold ${activeFeature === feature.id ? "text-white" : "text-gray-400"}`}>
                        {feature.title}
                      </h3>
                      {activeFeature === feature.id && (
                        <motion.p
                ...
                <div className="relative bg-gray-950 rounded-2xl shadow-xl overflow-hidden border border-gray-900">
                  <div className="p-6">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-200">{currentFeature.title}</h3>
                    </div>
